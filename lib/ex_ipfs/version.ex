defmodule ExIPFS.Version do
  @moduledoc """
  ExIPFS.Version is a collection of functions for the ExIPFS library.
  """
  import ExIPFS.Api
  import ExIPFS.Utils
  alias ExIPFS.VersionDeps

  defstruct [:commit, :golang, :version, :repo, :system]

  @typedoc """
  ExIPFS.Version.version is a struct to show the version of the IPFS daemon.
  """
  @type t :: %__MODULE__{
          commit: binary(),
          golang: binary(),
  ...
  @typedoc """
  ExIPFS.Version.deps is a struct to show deps of the IPFS daemon.
  """
  @type deps :: %ExIPFS.VersionDeps{
          path: binary(),
          replaced_by: binary(),
          sum: binary(),
          version: binary()
