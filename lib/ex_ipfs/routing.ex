defmodule ExIPFS.Routing do
  @moduledoc """
  ExIPFS.Routing is where the routing commands of the IPFS API reside.
  """
  ...
  """
  @spec findpeer(ExIPFS.peer_id(), list()) :: {:ok, any} | ExIPFS.Api.error_response()
  ...
  """
  @spec findprovs(ExIPFS.peer_id(), list()) :: {:ok, any} | ExIPFS.Api.error_response()
  ...
  https://docs.ipfs.io/reference/http/api/#api-v0-routing-provide
    ...
    verbose - <bool>, # Write extra information.
  """
  @spec provide(binary(), list()) :: {:ok, any} | ExIPFS.Api.error_response()
  ...
  https://docs.ipfs.io/reference/http/api/#api-v0-routing-put
    verbose - <bool>, # Write extra information.
  """
  @spec put(binary(), binary, list()) :: {:ok, any} | ExIPFS.Api.error_response()
