defmodule ExIPFS.Diag do
  @moduledoc """
  ExIPFS.Diag is where the diag commands of the IPFS API reside.
  """
  import ExIPFS.Api
  import ExIPFS.Utils
  ...
  @type profile :: %ExIPFS.DiagProfile{
          output: Path.t(),
          timeout: binary,
          writer: pid,
          ref: reference,
  ...
  @spec cmds() :: {:ok, list} | ExIPFS.Api.error_response()
  def cmds() do
  ...
  @spec clear() :: {:ok, any} | ExIPFS.Api.error_response()
  def clear do
  ...
  """
  # FIXME: return a proper struct
  @spec set_time(binary()) :: {:ok, any} | ExIPFS.Api.error_response()
  ...
  """
  # FIXME: verify return type
  @spec sys() :: {:ok, map} | ExIPFS.Api.error_response()
  def sys do
    post_query("/diag/sys")
    |> okify()
  end
  ...
  @spec profile(list) :: {:ok, any} | ExIPFS.Api.error_response()
  def profile(options \\ []) do
    ExIPFS.DiagProfile.start_link(options)
  end
end
