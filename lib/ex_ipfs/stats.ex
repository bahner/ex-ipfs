defmodule ExIPFS.Stats do
  @moduledoc """
  ExIPFS.Stats is where the stats commands of the IPFS API reside.
  """
  import ExIPFS.Api
  import ExIPFS.Utils
  ...
  """
  @spec bitswap(list()) :: {:ok, any} | ExIPFS.Api.error_response()
  def bitswap(opts \\ []) do
  ...
  """
  @spec bw(list()) :: {:ok, any} | ExIPFS.Api.error_response()
  def bw(opts \\ []) do
  ...
  """
  @spec dht(binary()) :: {:ok, any} | ExIPFS.Api.error_response()
  def dht(name) do
  ...
  """
  @spec provide() :: {:ok, any} | ExIPFS.Api.error_response()
  def provide do
  ...
  """
  @spec repo(list()) :: {:ok, any} | ExIPFS.Api.error_response()
  def repo(opts \\ []) do
