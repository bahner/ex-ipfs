defmodule ExIPFS.Name do
  @moduledoc """
  ExIPFS.Name is where the name commands of the IPFS API reside.
  """
  import ExIPFS.Api
  import ExIPFS.Utils
  ...
  """
  @spec pubsub_cancel(binary) :: {:ok, any} | ExIPFS.Api.error_response()
  ...
  """
  @spec pubsub_state :: {:ok, any} | ExIPFS.Api.error_response()
  def pubsub_state do
  ...
  """
  @spec pubsub_subs :: {:ok, any} | ExIPFS.Api.error_response()
  def pubsub_subs do
