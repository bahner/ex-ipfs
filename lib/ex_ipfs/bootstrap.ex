defmodule ExIPFS.Bootstrap do
  @moduledoc """
  ExIPFS.Bootstrap is where the bootstrap commands of the IPFS API reside.
  ...
  """
  @spec bootstrap() :: {:ok, ExIPFS.peers()} | ExIPFS.Api.error_response()
  def bootstrap do
  ...
  """
  @spec add(Path.t()) :: {:ok, ExIPFS.peers()} | ExIPFS.Api.error_response()
  ...
  @spec add_default(Path.t()) ::
          {:ok, ExIPFS.peers()} | ExIPFS.Api.error_response()
  ...
  """
  @spec list() :: {:ok, ExIPFS.peers()} | ExIPFS.Api.error_response()
  def list do
  ...
  """
  @spec rm(Path.t()) :: {:ok, ExIPFS.peers()} | ExIPFS.Api.error_response()
  def rm(peer) do
  ...
  """
  @spec rm_all() :: {:ok, ExIPFS.peers()} | ExIPFS.Api.error_response()
  def rm_all do
