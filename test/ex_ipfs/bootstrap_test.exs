defmodule ExIPFS.BootstrapTest do
  @moduledoc """
  Test the ExIPFS API bootstrap commands

  """
  use ExUnit.Case, async: true
  alias ExIPFS.Bootstrap
  ...
  test "test add a misnamed peer without /" do
    ...
    assert %ExIPFS.ApiError{} = boostrap
