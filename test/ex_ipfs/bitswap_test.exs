defmodule ExIPFS.BitswapTest do
  @moduledoc """
  Test the ExIPFS API
  ...
  test "wantlist should return wantlist" do
    ...
    assert %ExIPFS.BitswapWantList{} = wantlist
  ...
  test "ledger should return ledger" do
    ...
    assert %ExIPFS.BitswapLedger{} = ledger
  ...
  test "stat should return stat" do
    ...
    assert is_map(stat)
    assert %ExIPFS.BitswapStat{} = stat
